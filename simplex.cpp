...
Tableau tab  = { 5, 5, {                     // Size of tableau [4 rows x 5 columns ]
    {  0.0 , -1.0 , -2.0 ,-3.0 , -4.0,   },  // Max: z = 0.5*x + 3*y + z + 4*w,
    { 5 ,  -1.0 ,  0.0 , 0.0 ,  0.0,   },  //    x + y + z + w <= 40 .. b1
    { 6 , 0.0 , -1.0 , 0.0 ,  0.0,   },  //  -2x - y + z + w <= 10 .. b2
    { 7 ,  0.0 ,  0.0 , -1.0 , 0.0,   },
    { 8 ,  0.0 ,  0.0 , 0.0 , -1.0,   },  //        y     - w <= 10 .. b3
  }
};
